...
model = Word2Vec(sentences, vector_size=500, window=5, min_count=5, sg=1)
...
"""##Enter your Book name and genre here"""

recommendations = get_recommendations("Atomic Habits", "Others", final_df.sample(10000), word2vec_model_recommender)
recommendations
